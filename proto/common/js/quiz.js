var singleChoice = function (spec) {
    ...
    function init() {
        ...
        var fullpopClose = document.querySelectorAll(".popup-full .button-close");
        for (var k = 0; k < fullpopClose.length; ++k) {
            fullpopClose[k].addEventListener(amt.mouseTouchEvent.click, function(){
                exporter.reset();
            });
        }
