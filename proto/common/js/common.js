...
var createHiddenBox = function (spec) {
    ...
    function hnClick(e) {
        ...
        if (box.dataset.group) {
            ...
            if($(e.currentTarget).hasClass("hide") == true){
                iconBox.classList.remove("hide");
                iconBox.classList.remove("opacity");

                box.classList.remove("on");
            }else{
                // iconBox.classList.remove("over");
                iconBox.classList.add("hide");
                iconBox.classList.add("opacity");
                // box.classList.add("on");
                setTimeout(function () {
                    box.classList.add("on");
                }, 100);
        ...
        var numOpenBox = $(".icon-box.hide").length;
        if (numOpenBox === boxes.length) {
            alert("adfsad")
