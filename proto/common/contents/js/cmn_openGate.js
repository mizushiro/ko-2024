...
function openGateInit() {
    if(document.location.href.indexOf("401_1.html") != -1 || document.location.href.indexOf("proto_km_402.html") != -1){
        ...
        ($ts.getEl(".checkContainer").length || $ts.getEl(".isActiveContainer").length) && (t = $ts.getEl(".checkContainer").length ? $ts.getEl(".checkContainer .gate_container")[0] : $ts.getEl(".isActiveContainer .gate_container")[0], e = $ts.ce({
            ...
            parent: n
        }), a = $ts.getEl(".checkContainer").length ? "quiz_main_ani" : "quiz_main_ani", $ts.loadScriptFile("../common/contents/js/createjs.js", function () {
            $ts.loadScriptFile("../common/contents/js/canvasMainNew.js", function () {
                    ...
                    $(document).ready(function(){
                        ...
                        * */
                        ...
                        var pBtnHtml = '<span class="cl_sticker">\n' +
                            '\t\t\t\t<img class="on" src="../common/contents/images/icon/sticker.png" alt="기본 이미지">\n' +
                            '\t\t\t\t<img class="last" src="../common/contents/images/icon/sticker_hover.png" alt="클릭시 이미지">\n' +
                            '\t\t\t</span>';
                        ...
                        let clapSound = new Audio("../common/contents/media/clap.mp3");
        ...
        ($ts.getEl(".checkContainer").length || $ts.getEl(".isActiveContainer").length) && (t = $ts.getEl(".checkContainer").length ? $ts.getEl(".checkContainer .gate_container")[0] : $ts.getEl(".isActiveContainer .gate_container")[0], e = $ts.ce({
            ...
            id: "dom_overlay_container",
            parent: n
        }), a = $ts.getEl(".checkContainer").length ? "commonConfirm_Main" : "isActive_Main", $ts.loadScriptFile("../common/contents/js/createjs-2015.11.26.min.js", function () {
            $ts.loadScriptFile("../common/contents/js/" + a + ".js", function () {
                $ts.loadScriptFile("../common/contents/js/canvasMain.js", function () {
                    init()
                })
            })
        })), i.addEventListener("click", $efSound.click), i.addEventListener("click", openGateEvent)
