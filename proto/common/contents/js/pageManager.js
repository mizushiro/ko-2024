...
$ts.loadScriptFile("../common/libs/js/polyfills.js"),
    function() {
        var t = $ts.ce({
                tag: "div",
                class: "loadingImage",
        ...
        window.parent == window ? (console.log("[  Run Contents Mode(no UI)  ]"), document.querySelector("html").classList.add("noUI"), $ts.loadScriptFile("../common/libs/js/scale.js", function() {
        ...
        function n() {
            $ts.loadScriptFile("../common/libs/js/drag.js", function() {
            ...
            }), $ts.getEl("[drag]") && $ts.loadScriptFile("../common/content/js/simpleDrag.js");
                        ...
                        var o = t[i].getAttribute("data-popup-btn"),
                            ...
                            p = $popup({
                                ...
                                callBack: {
                                    open: function(t) {
                                        var e;
                                        for(i=1; i<=f.popup.length; i++){
                                            f.popup[i].isOpened = false;
                                        }
            ...
            }), $ts.getEl("[data-zoom-container]") && $ts.loadScriptFile("../common/libs/js/zoomImage.js", function() {
